			...
			<form action="insert" method="post" enctype="multipart/form-data"
				...
				<div class="row gy-4">
							...
							<div class="bs-stepper-content">
								<div id="test-nl-1" class="content">
									<div class="form-group my-3" style="">
										...
										<hr class="divider-w mt-10 mb-20">
										<h4>스타일</h4>
										<select class="form-control" name="goods_style"
											id="goods_style" title="상품 스타일">
											<option value="">(선택)</option>
									...
									<div class="d-flex justify-content-between  mb-5">
										<a class="btn btn-primary text-white justify-content-end"
											onclick="stepper2.next()">다음</a>
									</div>
								</div>
								...
								<div id="test-nl-2" class="content">
									<div class="form-group my-4 ">
										...
										<input class="form-control input-lg" type="text"
											placeholder="상품명" name="goods_name" id="goods_name" value="" />
									</div>
									<hr class="divider-w mt-10 mb-20">
									<div class="form-group">
										<h4>판매가</h4>
										<input class="form-control input-lg" type="number"
											placeholder="판매가 / 단위 : 원" name="goods_price"
											id="goods_price" value="" />
									</div>
									<hr class="divider-w mt-10 mb-20">
								...
								id="checkPriceBtn">상품가격 확인하기</button> -->
									<div class="form-group">
										...
										<input id="calculated_price" name="goods_sale_price" value=""
											style="display: none">
									</div>
									<div class="d-flex justify-content-between  mb-5">
										<a class="btn btn-info text-white justify-content-start"
											onclick="stepper2.previous()">이전</a> <a
											class="btn btn-primary text-white justify-content-start"
											onclick="stepper2.next()">다음</a>
									</div>
								</div>
								...
								<div id="test-nl-3" class="content">
									<div class="form-group">
										...
										<textarea class="form-control input-lg"
											placeholder="내용을 입력하세요" name="goods_info" id="goods_info"></textarea>
									</div>
								...
								<div id="test-nl-4" class="content">
									...
									<div class="form-group ">
										...
										<input name="file_main_name" value="" style="display: none">
										<input name="goods_main_image" value="" style="display: none">
									</div>
									...
									<div class="form-group ">
										...
										<input name="file_sub_name" value="" style="display: none">
										<input name="goods_sub_image" value="" style="display: none">
									</div>


									<div class="d-flex justify-content-between  mb-5">
										<a class="btn btn-info text-white justify-content-start"
											onclick="stepper2.previous()">이전</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4">
						<section id="portfolio-details" class="portfolio-details">
							<div class="portfolio-info">
								...
								<ul style="cursor: pointer">
									<li onclick="moveStep(1);"><strong>분류</strong>:<a
										id="categorys"></a></li>
									<li onclick="moveStep(2);"><strong>상품명</strong>:<a
										id="goods_info_name"></a></li>

									<li onclick="moveStep(2);"><strong>가격정보</strong>: <a
										id="price1"></a></li>
									<li onclick="moveStep(3);"><strong>성별</strong>:<a
										id="gender_info"></a></li>
									<li onclick="moveStep(3);"><strong>상세정보</strong>:<a
										id="goods_info_text"></a></li>
									<li onclick="moveStep(4);">이미지
										<div class="row">
											<div class="col-４">
												<strong>메인</strong>: <img class="img-thumbnail" alt="상품 이미지"
													onerror="this.onerror=null; this.src='<c:url value="/img/error_img.gif"/>;'" />
											</div>
											<div class="col-４">
												<strong>서브</strong>: <img class="img-thumbnail" alt="상품 이미지"
													onerror="this.onerror=null; this.src='<c:url value="/img/error_img.gif"/>;'" />
											</div>
										</div>
						...
						<a type="submit" class="btn text-white btn-success col-md-12"
							id="submit">입력완료</a>
					</div>
...
<script>
	...
	const goodsMiddleCategory = '';
	const goodsSubCategory = '';
	const goodsStyleCategory = '';
	const goodsSalepercent = '';
	const goodsGender = '';

	const mainCategories = [ "상의", "아우터", "하의", "원피스", "스커트", "신발", "가방",
			"악세사리", "양말", "시계", "모자" ];
	const styleCategories = [ "캐쥬얼", "스트릿", "댄디", "아메카지", "고프코어", "스포츠", "로맨틱",
			"걸리쉬", "시크" ];
	const subCategories = {
		1 : [ "니트/스웨터", "후드 티셔츠", "맨투맨/스웨트셔츠", "긴소매 티셔츠", "셔츠/블라우스",
				"피케/카라티셔츠", "반소매 티셔츠", "민소매 티셔츠", "기타 상의" ],
		2 : [ "후드 집업", "블루종/MA-1", "레더/라이더스 재킷", "무스탕/퍼", "트러커 재킷",
				"슈트/블레이저 재킷", "카디건", "아노락 재킷", "플리스/뽀글이", "트레이닝 재킷", "환절기 코트",
				"겨울 싱글 코트", "겨울 더블 코트", "롱패딩/롱헤비 아우터", "숏패딩/숏헤비 아우터", "패딩 베스트",
				"베스트", "사파리/헌팅 재킷", "나일론/코치 재킷", "기타 아우터" ],
		3 : [ "데님 팬츠", "코튼 팬츠", "슈트 팬츠/슬랙스", "트레이닝/조거 팬츠", "숏 팬츠", "레깅스",
				"점프 슈트/오버올", "스포츠 하의", "기타 바지" ],
		4 : [ "미니 원피스", "미디 원피스", "맥시 원피스" ],
		5 : [ "미니스커트", "미디스커트", "롱스커트" ],
		6 : [ "구두", "로퍼", "힐/펌프스", "플랫 슈즈", "블로퍼", "샌들", "슬리퍼", "기타 신발",
				"모카신/보트 슈즈", "신발 용품", "캔버스/단화", "패션스니커즈화", "스포츠 스니커즈",
				"기타 스니커즈" ],
		7 : [ "백팩", "메신저/크로스 백", "숄더백", "토트백", "에코백", "보스턴/드럼/더플백", "웨이스트 백",
				"파우치 백", "모카신/보트 슈즈", "브리프케이스", "캐리어", "가방 소품", "지갑/머니클립",
				"클러치 백", "기타 가방" ],
		8 : [ "팔찌", "반지", "목걸이/펜던트", "귀걸이", "발찌", "브로치/배지", "헤어 악세사리",
				"기타 악세사리" ],
		9 : [ "양말", "스타킹", "기타 양말" ],
